...
const frontend = [
  ...
  { name: "Next.js", src: "https://cdn.simpleicons.org/next.js/000000", description: "Built two projects with Next.js, including one currently in development." },
  ...
  { name: "Vue.js", src: "https://cdn.simpleicons.org/vue.js/4FC08D", description: "Learned basics and completed one project with it." },
...
const backend = [
  ...
  { name: "Supabase", src: "https://cdn.simpleicons.org/supabase/3FCF8E", description: "A backend-as-a-service offering authentication, storage, and PostgreSQL." },
  { name: "Railway", src: "https://cdn.simpleicons.org/railway/0B0D0E", description: "A deployment platform I use for hosting backend services and databases." },
];
          ...
          >
            {frontend.map((tech) => (
              <div key={tech.name} className="border border-gray-300 dark:border-gray-600 p-4 rounded-lg flex flex-col justify-center items-center min-w-[200px]">
                <Image src={tech.src} alt={tech.name} width={50} height={50} className="hidden lg:block" />
