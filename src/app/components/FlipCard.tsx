...
const FlipCard = () => {
  ...
  return (
    <div className="min-w-full p-5 flex justify-center items-center" style={{ perspective: "1000px", height: "100%" }}>
      <motion.div
        className="relative w-full rounded-xl shadow-lg cursor-pointer"
        initial={false}
      ...
      >
        {/* Front Side */}
        <div
          className="absolute w-full h-full bg-white dark:bg-gray-800 text-gray-900 dark:text-white flex flex-col justify-center items-center rounded-xl border border-gray-300 dark:border-gray-600 p-6"
        ...
        >
          ...
          <div className="w-full flex flex-col gap-5 md:grid md:grid-cols-2 lg:grid-cols-3">
            {techStack.map((tech) => (
            <div key={tech.name} className="border border-gray-300 dark:border-gray-600 p-4 rounded-lg flex flex-col justify-center items-center">
                <Image 
                    src={tech.src} 
                    alt={tech.name} 
                    width={60} 
        ...
        >
          <h1 className="text-xl font-semibold text-center">Backend Info Coming Soon!</h1>
        </div>
      </motion.div>
    </div>
  );
